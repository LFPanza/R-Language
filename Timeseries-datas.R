...
# dados de séries temporais. Abaixo uma lista dos principais pacotes e objetos usados para análise de séries 
# temporais em R.
...
my.dates = seq(as.Date("2015/1/1"), as.Date("2016/12/31"), "3 months")
head(my.dates)
tail(my.dates) 
